...
//// the following lines interpret the actual in app payment item IDs from the server into a SKU we can use in app.
...
public static final String SKU_ISSUE_PRO_UPGRADE_DISCOUNTED = "pro299";
...
public static PurchaseHelper createInstance(){
    if (mInstance==null){
        ...
        purchaseHelper1.mPurchaseItems.add(new PurchaseItem(SKU_ISSUE_PRO_UPGRADE,false, Features.Alerts));
        purchaseHelper1.mPurchaseItems.add(new PurchaseItem(SKU_ISSUE_PRO_UPGRADE_DISCOUNT,false, Features.Alerts));
        purchaseHelper1.mPurchaseItems.add(new PurchaseItem(SKU_ISSUE_PRO_UPGRADE_DISCOUNTED,false, Features.Alerts));
        purchaseHelper1.mPurchaseItems.add(new PurchaseItem(SKU_ISSUE_PRO_UPGRADE_SUBSCRIPTION, false, Features.AuroraAlerts));
        ...
        purchaseHelper1.mPurchaseItems.add(new PurchaseItem(SKU_ISSUE_PRO_UPGRADE_SUBSCRIPTION, false, Features.UpgradeProSubscription));
...
public boolean isPurchased(Features feature){
    ...
    //// set below line to true to automatically enable all pro version features for testing. Set back to false before deployment.
