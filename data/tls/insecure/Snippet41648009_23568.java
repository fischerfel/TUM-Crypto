    ...
    mThread = new Thread(new Runnable() {
        ...
        public void run() {
            try {
                ...
                Parser.HappyDataInputStream stream = new Parser.HappyDataInputStream(mSocket.getInputStream());
...
private String readLine(Parser.HappyDataInputStream reader) throws IOException {
